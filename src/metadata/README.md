 ...
 * [agro.yml](agro.yml)
     * Determines how your purl.obolibrary.org/obo/agro/ redirects will be handled
     ...
     * Paste in the contents of [agro.yml](agro.yml)
 ...
 * [agro.md](agro.md)
     ...
     * Paste in the contents of [agro.md](agro.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
